...
console.log(greetUser("Smitty Werben Jager-Manjensen"));
...
//console.log(canWeDeliver(27713));
...
console.log(canWeDeliverTwo(deliveryAreaZipCodes, 27713));
