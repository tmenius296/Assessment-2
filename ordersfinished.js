...
//CODE HERE
class Ticket {
  constructor(items, orderTime, custId) {
    this.items = items;
  ...
  updateStatus = (newStatus) => {
    ...
    console.log(`The order for ${this.custId} is now ${newStatus}`);
  };
}

const testTicket = new Ticket([], 3, "TrentID007");
//testTicket.updateStatus('Cool Beans')
...
//CODE HERE
const firstTicket = new Ticket("pizza", 4, "Trenton872296");
/*
